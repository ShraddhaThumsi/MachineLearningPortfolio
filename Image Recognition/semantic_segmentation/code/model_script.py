...
#main inspiration for this project was ProjectPro Image Segmentation module. They had written it in Pytorch so I used existing Tensorflow equivivalents to compose my code_old.
