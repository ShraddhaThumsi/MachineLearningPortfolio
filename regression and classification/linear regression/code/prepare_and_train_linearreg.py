...
#the theoretical material gotten from ProjectPro implements the linear regression and classification using Statsmodels package. Here I am doing it using sklearn
lr = LinearRegression()
