...
print()
print('*******************')
print('now invoking random forest')
print(Models.random_forest(X_train_new, y_train,loop='training'))
print(Models.random_forest(X_val_new,y_val,loop='validation'))
print(Models.random_forest(X_test_new,y_test,loop='test'))
print('*******************')
print()
...
print()
print('*******************')
print('now invoking naive bayes classifier')
print(Models.naive_bayes(X_train_new, y_train,loop='training'))
print(Models.naive_bayes(X_val_new,y_val,loop='validation'))
print(Models.naive_bayes(X_test_new,y_test,loop='test'))
print('*******************')
print()
...
print()
print('*******************')
print('now invoking K Nearest Neighbors')
print(Models.knn(X_train_new, y_train,loop='training'))
print(Models.knn(X_val_new,y_val,loop='validation'))
print(Models.knn(X_test_new,y_test,loop='test'))
print('*******************')
print()

print()
print('*******************')
print('now invoking support vector classifier')
print(Models.support_vector_classifier(X_train_new, y_train,loop='training'))
print(Models.support_vector_classifier(X_val_new,y_val,loop='validation'))
print(Models.support_vector_classifier(X_test_new,y_test,loop='test'))
print('*******************')
print()